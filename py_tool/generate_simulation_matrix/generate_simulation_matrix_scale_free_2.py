...
network_size = list(network_size)[::2]
network_size = network_size[::-1]  # Reverse the list

network_generator = "large_scale_simulation_generator_social_network"
...
if __name__ == "__main__":
    ...
    with open("run_simulation_matrix_scale_free_2.py", "w") as run_script:
